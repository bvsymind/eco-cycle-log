...
export const transaksiService = {
  ...
  // Add new transaction (setor)
  async addSetor(transaksi: Omit<Transaksi, 'id' | 'created_at'>): Promise<string> {
  ...
  // Add new transaction (tarik)
  async addTarik(id_nasabah: string, nama_nasabah: string, amount: number): Promise<string> {
    const batch = writeBatch(db);
